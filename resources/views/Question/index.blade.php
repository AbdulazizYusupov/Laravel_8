            ...
            <div class="container-fluid">
                ...
                <div class="row mb-2">
                    <div class="col-sm-6 mt-2">
                        <a href="/create-question" class="btn btn-primary">Create</a>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                @foreach ($models as $model)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="modal fade" id="add{{ $model->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <h4 class="ml-3">Variant kiriting</h4>
                                                        <form action="/variant" method="POST">
                                                            @csrf
                                                            <div class="modal-body">
                                                                <input type="hidden" name="savol_id"
                                                                    value="{{ $model->id }}">
                                            ...
                                            <div class="modal fade" id="edit{{ $model->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="{{ route('question.update', $model->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('PUT')
                                                            <div class="modal-body">
