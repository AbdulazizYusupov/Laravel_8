        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <section id="blog-details" class="blog-details section">
                        <div class="container">
                            ...
                            <article class="article">
                                ...
                                <div class="post-img">
                                    <img src="{{ $models->img }}" alt="" width="100%" class="img-fluid">
                                </div>

                                <h2 class="title">{{ $models->title }}</h2>
                                ...
                                <div class="d-flex">
                                    <form action="{{ route('likes') }}" method="POST">
                                        @csrf
                                        <input type="hidden" name="post_id" value="{{ $models->id }}">
                                ...
                                <div class="mt-4">
                                    <i class="bi bi-eye">
                                        <a href="#" class="text-dark">{{ $models->view }}</a>
                                    </i>
                                </div>
                            </article>
                        </div>
                    ...
                    <section id="blog-posts" class="blog-comments section">
                        @if (isset($comments[0]))
                            <div class="container">
                                ...
                                <div class="add-comment mt-4">
                                    ...
                                    <form action="/create-comment" method="POST">
                                        ...
                                        <div class="form-group">
                                            <textarea name="body" rows="3" class="form-control" placeholder="Write your comment here..." required></textarea>
                                        </div>
                                        <input type="hidden" name="post_id" value="{{ $models->id }}">
